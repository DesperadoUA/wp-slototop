...
function register_post_types_bonus(){
    register_post_type( 'bonus', [
        ...
        'labels' => [
            ...
            'add_new'            => 'Добавить Bonus', // для добавления новой записи
            'add_new_item'       => 'Добавление Bonus', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => 'Редактирование Bonus', // для редактирования типа записи
            'new_item'           => 'Новый Bonus', // текст новой записи
            ...
            'menu_name'          => 'Bonuses', // название меню
        ],
        'description'         => '',
        'public'              => true,
